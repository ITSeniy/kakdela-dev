...
export const Icon = {
  ...
  // Календарь — встречи (EventCard и кнопка в композере).
  Calendar: makeIcon(
    <>
  ...
  // Закладка — «заметки себе» в списке личных сообщений.
  Bookmark: makeIcon(<path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />),
  // Столбики — опрос (карточка PollCard и кнопка в композере).
  BarChart: makeIcon(
    <>
  ...
  // Перечёркнутый колокол — замьюченный канал/сервер/диалог.
  BellOff: makeIcon(
    <>
      <path d="M13.73 21a2 2 0 0 1-3.46 0" />
